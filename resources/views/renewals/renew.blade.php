...
<div class="container">
    ...
    <!-- Policy edit form -->
    <form method="POST" action="{{ route('renewals.store', $policy->id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-2 form-group">
            ...
            <input type="text" id="customer_code_display" class="form-control" readonly value="{{ old('customer_code', $policy->customer_code) }}" disabled>
        ...
        <div class="col-md-6 form-group">
            ...
            <input type="text" id="customer_name_display" class="form-control @error('customer_name') is-invalid @enderror" readonly value="{{ old('customer_name', $policy->customer_name) }}" disabled>
    ...
    <div class="col-md-2 form-group">
            ...
            <input type="text" id="fileno" name="fileno" class="form-control" value="{{ old('fileno', $policy->fileno) }}"  disabled>
        </div> 
...
<script>
    ...
    function formatInput(input) {
        let value = input.value.replace(/[^\d.]/g, ''); // Remove any non-numeric characters except decimal
        if (value) {
    ...
    function calculateRateFromPremium() {
        ...
        const rate = (premium / sumInsured) * 100;
