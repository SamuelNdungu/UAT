...
<div class="container fancy-container">
    <div class="gradient-banner mb-4">
        <div class="d-flex align-items-center">
            ...
            <h1 class="my-2 mb-0" style="font-weight: 700; letter-spacing: 1px;">Add Vehicle Type</h1>
        </div>
        <p class="text-muted mb-0" style="font-size:1.1rem;">Fill in the details below to add a new vehicle type to the system.</p>
    </div>
            ...
            <form method="POST" action="{{ route('vehicle_types.store') }}">
                ...
                <div class="mb-3 position-relative">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="make" name="make" placeholder="e.g. Toyota" value="{{ old('make') }}">
                    </div>
                    @error('make')
                ...
                <div class="mb-3 position-relative">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="model" name="model" placeholder="e.g. Corolla" value="{{ old('model') }}">
                    </div>
                    @error('model')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
