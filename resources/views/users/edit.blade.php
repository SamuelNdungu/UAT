...
<div class="container fancy-container">
    <div class="gradient-banner mb-4">
        <div class="d-flex align-items-center">
            ...
            <h1 class="my-2 mb-0" style="font-weight: 700; letter-spacing: 1px;">Edit User</h1>
        </div>
        <p class="text-muted mb-0" style="font-size:1.1rem;">Update the details below to modify this user.</p>
    </div>
            ...
            <form method="POST" action="{{ route('users.update', $user->id) }}">
                ...
                <div class="mb-3 position-relative">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="e.g. John Doe" value="{{ old('name', $user->name) }}">
                    </div>
                    @error('name')
                ...
                <div class="mb-3 position-relative">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="e.g. johndoe@email.com" value="{{ old('email', $user->email) }}">
                    </div>
                    @error('email')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
